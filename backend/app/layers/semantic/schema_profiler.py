"""
app/layers/semantic/schema_profiler.py
══════════════════════════════════════════════════════════════════════
Schema Profiler — moved from services/schema_profiler.py.
...
from app.layers.semantic.semantic_classifier import classify_all_columns
